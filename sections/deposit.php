...
<head>
    ...
    <title>Online ATM - Deposit Money</title>
</head>
...
<body>
    <main class="form-signin border shadow bg-white rounded">
        <form method="post">
            ...
            <button onclick="return confirm('Proceed to deposit money?')" type="submit" class="w-100 btn btn-primary" name="deposit">Deposit Money</button>
